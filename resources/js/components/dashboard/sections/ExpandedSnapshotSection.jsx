...
export default memo(function ExpandedSnapshotSection({ twitterUrl }) {
    return (
        <div className="flex relative overflow-hidden flex-col gap-3.5 border-8 border-white rounded-[36px] lg:p-[37px] p-[31px] items-center">
            <img src="/assets/img/dashboard-blur.png" loading="lazy" decoding="async" className="absolute h-full w-full object-cover left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2" alt="" />
