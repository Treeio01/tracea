...
export default function BehaviorSection() {
    return (
        <section id="behavior" className="flex relative flex-col items-center gap-[258px] w-full max-w-[1420px] lg:mt-[140px] mt-[30px]">
           <SectionHeader
                    badge="Behavior"
            ...
            <div className="behavior-top flex self-end flex-col gap-4.5 w-full max-w-[433px] z-50" data-scroll-animate="slide-in-right-80">
            ...
            <div className="behavior-bottom lg:flex hidden self-start flex-col items-start gap-4.5 max-w-[755px] z-50" data-scroll-animate="slide-in-left-80">
                <SectionHeader
                    badge="Behavior"
                    title="Behavior over Price"
                    align="left"
