...
export default function MainSection() {
    ...
    return (
        <section ref={sectionRef} id="hero" className="flex overflow-hidden relative w-full items-center justify-center max-w-[1770px] lg:p-[66px] p-[31px] lg:pb-[512px] pb-[160px] lg:pt-[66px] pt-[97px] 1395:rounded-[26px] rounded-[0px] lg:bg-white bg-[#F6F6F6] 1395:border border-none border-[#D9D9D9]">
